...
public class TestServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Implementation class of config is :: " + servletConfig.getClass().getName());
		System.out.println("Implementation class of context is :: " + servletContext.getClass().getName());
